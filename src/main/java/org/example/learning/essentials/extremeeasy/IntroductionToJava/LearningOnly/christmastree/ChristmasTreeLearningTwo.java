 ...
 */
public class ChristmasTreeLearningTwo {

    private static final Logger logger = LoggerFactory.getLogger(ChristmasTreeLearningTwo.class);
    ...
    public static void main(String[] args) {
        ...
        ChristmasTreeLearningTwo christmasTree = new ChristmasTreeLearningTwo();
